...
function cargarDatosFechaNota(){
	d3.json('datosFechaNota.txt', function(err, data){
		...
		console.log(datosFechaNota.length);
...
function graficarFechaNota(){
	...
	*/
	...
	var circles = circlesGroup.selectAll("circle")
						...
						//.style("fill", function (d) { return '#' +(6666666*d.alumnoid).toString(16);  })
	...
	*/
    ...
    var textoAlumnos = grupoTextoAlumnos
                      ...
                      .enter()
                      .append("text")
                      .attr("id",function(d) {console.log(d.alumnonombre); return "ttt_" + d.alumnoid;})
