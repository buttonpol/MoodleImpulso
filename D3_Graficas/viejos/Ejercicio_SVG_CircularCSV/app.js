...
function graficar(){
	...
	*/ 
	...
	var svgLista = d3.select("body").append("svgTexto")
		.attr("width", width/2)
		.attr("height", height/2)
		.append("l")
	...
	var gLista = svgLista.selectAll("l")
		.enter()
		.append("l")
		.attr("class","list")
		.text("hola")
	; //un atributo arc para adm estilos en css para cada elemento.

	gLista.append("pathLista")
	;
		...
		*/
		...
		g.append("path") // para dibujar elementos que pueden no ser 'primitiva'
		    ...
		    .on("click", function(){
		   		d3.select(this) // this es el elemento que está activo ahora en la iteración.
		   		//.style("fill", "red")
				.html("<a href='www.google.com'>new page</a>")
			})
		   	;
